...
set_target_properties(OPENFHEcore PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libOPENFHEcore.so.1.2.4"
  IMPORTED_SONAME_RELEASE "libOPENFHEcore.so.1"
  )

list(APPEND _cmake_import_check_targets OPENFHEcore )
list(APPEND _cmake_import_check_files_for_OPENFHEcore "${_IMPORT_PREFIX}/lib/libOPENFHEcore.so.1.2.4" )
...
set_target_properties(OPENFHEpke PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libOPENFHEpke.so.1.2.4"
  IMPORTED_SONAME_RELEASE "libOPENFHEpke.so.1"
  )

list(APPEND _cmake_import_check_targets OPENFHEpke )
list(APPEND _cmake_import_check_files_for_OPENFHEpke "${_IMPORT_PREFIX}/lib/libOPENFHEpke.so.1.2.4" )
...
set_target_properties(OPENFHEbinfhe PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libOPENFHEbinfhe.so.1.2.4"
  IMPORTED_SONAME_RELEASE "libOPENFHEbinfhe.so.1"
  )

list(APPEND _cmake_import_check_targets OPENFHEbinfhe )
list(APPEND _cmake_import_check_files_for_OPENFHEbinfhe "${_IMPORT_PREFIX}/lib/libOPENFHEbinfhe.so.1.2.4" )
